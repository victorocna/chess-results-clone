...
const Player_Pair = ({ board, name_w, name_b, rank_w, rank_b, rating_w, rating_b, result_w, result_b }) => {
    return (
      <div className="w-full mb-1 flex shadow">
          ...
          <div className="w-10/12 flex flex-col bg-neutral-300">
            <div className="h-full flex items-center border-b border-white">
              <p className="px-2 mx-1 text-[0.5rem] font-bold rounded bg-sky-600 text-white shadow font-['Roboto Mono']">
                {rank_w}
              </p>
